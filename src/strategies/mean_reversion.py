...
class MeanReversion(Strategy):
    ...
    def do_best_intervals(self, symbol, start_date, end_date, directory, long_term_minimum=25, long_term_maximum=300, short_term_minimum=2, short_term_maximum=200):
    ...
    # def get_iteration_count(self, long_term_minimum, long_term_maximum, short_term_minimum, short_term_maximum):
    #     count = 0
    #     for long_term in range(long_term_minimum, long_term_maximum):
